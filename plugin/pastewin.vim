...
if !exists('g:pastewin_default_delete_mappings')
  let g:pastewin_default_delete_mappings = 1
endif

if !exists('g:pastewin_default_yank_mappings')
  let g:pastewin_default_yank_mappings = 1
endif

if !exists('g:pastewin_default_paste_mappings')
  let g:pastewin_default_paste_mappings = 1
endif
...
if g:pastewin_default_mappings
  if g:pastewin_default_delete_mappings
  ...
  if g:pastewin_default_yank_mappings
